                                                ...
                                                wishlists.map((item, index) => (
                                                    <div className="wishlist_item_block" key={index}>
                                                        <div className="wishlist_details_products">
                                                            <Link to={`/${item.productItem.url}`}> 
                                                                <img src={item.productItem.image} alt={item.productItem.name} className="product_details_image" />
                                                            </Link>
                                                            <div className="wishlist_details_content">
                                                                ...
                                                                <div className="product_price_flex">
                                                                    <p className="item_price_div">
                                                                        <span className="item_price">₹{item.productItem.price.toLocaleString()}</span>
                                                                        <span className="item_price_actual">₹{item.productItem.cuttedPrice.toLocaleString()}</span>
                                                                    </p>
                                                                    <p className="discount_price">{item.productItem.discount}</p>
                                                                </div>
                                                            </div>
                                                        </div> 
