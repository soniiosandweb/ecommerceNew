...
import { ADD_WISHLIST_ERROR, ADD_WISHLIST_REQUEST, ADD_WISHLIST_SUCCESS, CLEAR_WISHLIST_ERRORS, GET_WISHLIST_ERROR, GET_WISHLIST_REQUEST, GET_WISHLIST_SUCCESS, REMOVE_WISHLIST_FAIL, REMOVE_WISHLIST_REQUEST, REMOVE_WISHLIST_SUCCESS } from "../Types/wishlistTypes";
...
export const addWishlistItem = (wishlistData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`/api/wishlist/new`, wishlistData, config);
